...
import 'package:clothes_app/services/loadDataUser.dart';
...
class AuthServices {
  ...
  //     print('Tại authService sau khi đăng nhập thanh công');
  //     print('Stored Username: $username');
  //     print('Stored Avatar URL: $avatar');
  //     print('Stored email: $email');
  //     print('Stored role: $role');
  //
  //     print('------------------');
  //   } catch (e) {
  //     print('Error printing user info: $e');
  //   }
  // }
}
